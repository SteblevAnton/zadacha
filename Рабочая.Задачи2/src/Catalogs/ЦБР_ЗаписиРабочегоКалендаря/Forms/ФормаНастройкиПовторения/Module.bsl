...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Не ЗначениеЗаполнено(ЧастотаПовторения) Тогда
		ЧастотаПовторения = Перечисления.ЦБР_ЧастотаПовторения.Еженедельно;
	КонецЕсли;
...
Процедура КоличествоПовторовПриИзменении(Элемент)
	...
	Если КоличествоПовторов < 1 Тогда
		КоличествоПовторов = 5;
		ПравилоОкончанияПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ПравилаОкончанияПовторения.Никогда");
		ТекущийЭлемент = Элементы.ПравилоОкончанияПовторения;
	Иначе
		ПравилоОкончанияПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ПравилаОкончанияПовторения.ПослеЧислаПовторов");
	КонецЕсли;
...
Процедура ДатаОкончанияПовторенияПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(ДатаОкончанияПовторения) Тогда
		ПравилоОкончанияПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ПравилаОкончанияПовторения.ДоДаты");
	Иначе
...
Процедура ОбновитьОтображение()
	...
	Если ПравилоОкончанияПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ПравилаОкончанияПовторения.Никогда") Тогда
		Элементы.СтраницыНастройкиПравилОкончанияПовторения.ТекущаяСтраница = Элементы.СтраницаПравилоОкончаниеНикогда;
	ИначеЕсли ПравилоОкончанияПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ПравилаОкончанияПовторения.ПослеЧислаПовторов") Тогда
		Элементы.СтраницыНастройкиПравилОкончанияПовторения.ТекущаяСтраница = Элементы.СтраницаПравилоОкончанияПосле;
	ИначеЕсли ПравилоОкончанияПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ПравилаОкончанияПовторения.ДоДаты") Тогда
	...
	Если ЗначениеЗаполнено(ЧастотаПовторения) Тогда
		...
		Если ЧастотаПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ЧастотаПовторения.Ежедневно") Тогда
			Элементы.СтраницыНастройки.ТекущаяСтраница = Элементы.СтраницаНастройкиДень;
		ИначеЕсли ЧастотаПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ЧастотаПовторения.Еженедельно") Тогда
			Элементы.СтраницыНастройки.ТекущаяСтраница = Элементы.СтраницаНастройкиНеделя;
		ИначеЕсли ЧастотаПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ЧастотаПовторения.Ежемесячно") Тогда
			Элементы.СтраницыНастройки.ТекущаяСтраница = Элементы.СтраницаНастройкиМесяц;
		ИначеЕсли ЧастотаПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ЧастотаПовторения.Ежегодно") Тогда
...
Функция ПолучитьПовторениеПоДнямНедели()
	...
	Если ЧастотаПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ЧастотаПовторения.Еженедельно") Тогда
...
Функция ПолучитьНастройкиПовторения()
	...
	Если ЧастотаПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ЧастотаПовторения.Ежемесячно") Тогда
	...
	Если ПравилоОкончанияПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ПравилаОкончанияПовторения.ПослеЧислаПовторов") Тогда
...
Функция ПроверитьКорректностьНастройкиПовторения()
	...
	Если ЧастотаПовторения = ПредопределенноеЗначение("Перечисление.ЦБР_ЧастотаПовторения.Еженедельно")
